...
#include <stddef.h>
#include "tutorial_interfaces/srv/detail/money__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tutorial_interfaces__srv__Money_Request__init(message_memory);
}

void Money_Request__rosidl_typesupport_introspection_c__Money_Request_fini_function(void * message_memory)
{
  tutorial_interfaces__srv__Money_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Money_Request__rosidl_typesupport_introspection_c__Money_Request_message_member_array[2] = {
  {
    ...
    offsetof(tutorial_interfaces__srv__Money_Request, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__srv__Money_Request, money),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Money_Request__rosidl_typesupport_introspection_c__Money_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(tutorial_interfaces__srv__Money_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, srv, Money_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  tutorial_interfaces__srv__Money_Response__init(message_memory);
}

void Money_Response__rosidl_typesupport_introspection_c__Money_Response_fini_function(void * message_memory)
{
  tutorial_interfaces__srv__Money_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Money_Response__rosidl_typesupport_introspection_c__Money_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__srv__Money_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__srv__Money_Response, money),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Money_Response__rosidl_typesupport_introspection_c__Money_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(tutorial_interfaces__srv__Money_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_tutorial_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, srv, Money_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_members = {
  "tutorial_interfaces__srv",  // service namespace
  "Money",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_Request_message_type_support_handle,
  NULL  // response message
  // tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_Response_message_type_support_handle
};

static rosidl_service_type_support_t tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_type_support_handle = {
  0,
  &tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, srv, Money)() {
  if (!tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_type_support_handle.typesupport_identifier) {
    tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, srv, Money_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, srv, Money_Response)()->data;
  }

  return &tutorial_interfaces__srv__detail__money__rosidl_typesupport_introspection_c__Money_service_type_support_handle;
}
