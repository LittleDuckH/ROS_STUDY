...
#include "tutorial_interfaces/srv/detail/money__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::srv::Money_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::Money_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::Money_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::Money_Request *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Money_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Money_Request)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Money_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tutorial_interfaces
cdr_serialize(
  const tutorial_interfaces::srv::Money_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::Money_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::Money_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::Money_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Money_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Money_Response)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Money_Response__handle;
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Money__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, Money)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_Money__handle;
}
