...
{
public:
  MinimalServicer(): Node("service_launch_test")
  {
    money_service_callbackgroup = create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);

    money_service = this->create_service<tutorial_interfaces::srv::Money>("service_launch_node", std::bind(&MinimalServicer::service_callback, this, _1, _2),
